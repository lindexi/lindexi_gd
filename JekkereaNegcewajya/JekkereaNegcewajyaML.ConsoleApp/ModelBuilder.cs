...
namespace JekkereaNegcewajyaML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\程序\ethylene156\lindexi_gd\JekkereaNegcewajya\JekkereaNegcewajya\1.tsv";
        private static string MODEL_FILEPATH = @"../../../../JekkereaNegcewajyaML.Model/MLModel.zip";
