...
var appHost = @"Microsoft.NETCore.App.Host.linux-loongarch64.9.0.5";
...
(
    ...
    // 输出路径，包括指定输出文件名
    appHostDestinationFilePath: "Xilium.CefGlue.BrowserProcess",
    // 入口的 DLL 是哪一个，这是相对于 exe 所在的 dll 路径
    appBinaryFilePath: "Xilium.CefGlue.BrowserProcess.dll",
