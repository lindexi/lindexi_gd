...
namespace NearniwucheaCayhaiheneML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"..\NearniwucheaCayhaihene\NearniwucheaCayhaihene\1.tsv";
        private static string MODEL_FILEPATH = @"../../../../NearniwucheaCayhaiheneML.Model/MLModel.zip";
