...
// ReSharper disable InconsistentNaming 这里面的命名都是乱的，也不修了，忽略就好
    ...
    public static class Direct3D
    {
        ...
        public interface IDirect3DDevice9
        {
            ...
            int CreateTexture(int Width, int Height, int Levels, int Usage, D3DFORMAT Format, int Pool,
                              out IDirect3DTexture9 ppTexture, ref IntPtr pSharedHandle);
            ...
            [PreserveSig, SuppressUnmanagedCodeSecurity]
            int StretchRect(IntPtr pSourceSurface, RECT pSourceRect, IDirect3DSurface9 pDestSurface, RECT pDestRect, int Filter);
            int ColorFill();
            ...
            int GetClipStatus();
            int GetTexture();
            int SetTexture(int index, IDirect3DTexture9 texture);
        ...
        public interface IDirect3DDevice9Ex : IDirect3DDevice9
        {
            ...
            new int StretchRect(IntPtr pSourceSurface, RECT pSourceRect, IDirect3DSurface9 pDestSurface, RECT pDestRect, int Filter);
            new int ColorFill();
