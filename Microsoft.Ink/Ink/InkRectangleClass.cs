...
// Type: Microsoft.Ink.InkRectangleClass
...
namespace Microsoft.Ink
{
  ...
  internal class InkRectangleClass : IInkRectangle, InkRectangle
  {
    ...
    [DispId(7)]
    public virtual extern tagRECT Data { [DispId(7), TypeLibFunc(64), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [TypeLibFunc(64), DispId(7), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
