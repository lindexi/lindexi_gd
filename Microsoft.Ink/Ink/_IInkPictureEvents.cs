...
// Type: Microsoft.Ink._IInkPictureEvents
...
namespace Microsoft.Ink
{
  ...
  [InterfaceType(2)]
  [ComImport]
  internal interface _IInkPictureEvents
  {
    [DispId(1)]
    ...
    [DispId(37)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void KeyDown([In, Out] ref short KeyCode, [In, Out] ref short Shift);

    [DispId(39)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void KeyUp([In, Out] ref short KeyCode, [In, Out] ref short Shift);
    ...
    [DispId(40)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void Resize([In, Out] ref int Left, [In, Out] ref int Top, [In, Out] ref int Right, [In, Out] ref int Bottom);

    [DispId(41)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void SizeChanged([In] int Left, [In] int Top, [In] int Right, [In] int Bottom);
    ...
    [DispId(23)]
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ChangeUICues([In] int UICues);
