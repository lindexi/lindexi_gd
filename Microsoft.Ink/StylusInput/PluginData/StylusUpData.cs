...
{
  public sealed class StylusUpData : StylusDataBase
  {
    private StylusUpData()
    {
    }

    public StylusUpData(Stylus stylus, int packetPropertyCount, int[] packetData) => this.Initialize(stylus, packetPropertyCount, packetData);
