...
// Type: Microsoft.StylusInput.PluginData.RealTimeStylusDisabledData
...
{
  public sealed class RealTimeStylusDisabledData : IEnumerable
  {
    private readonly int[] m_tcids;

    private RealTimeStylusDisabledData()
    {
    }

    internal RealTimeStylusDisabledData(int[] tcids) => this.m_tcids = tcids;
