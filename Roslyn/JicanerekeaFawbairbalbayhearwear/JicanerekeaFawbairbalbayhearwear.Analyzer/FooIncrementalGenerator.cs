...
using JicanerekeaFawbairbalbayhearwear.Analyzer.Properties;

using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.CSharp.Syntax;

namespace JicanerekeaFawbairbalbayhearwear.Analyzer;
                ...
                (GeneratorAttributeSyntaxContext syntaxContext, CancellationToken _) =>
                {
                    ...
                    var generatedCode =
                            $$"""
                              ...
                              {
                                  {{AccessibilityToString(methodSymbol.DeclaredAccessibility)}}{{(methodSymbol.IsStatic ? " static" : "")}} partial System.Collections.Generic.IEnumerable<{{exceptedFuncTypeName}}<{{constructorArgumentTypeName}}, {{collectionTypeName}}>>
                              {{methodSymbol.Name}}()
                                  {
                                      yield return context => new F1(context);
                                  }
                    ...
                    /*
                       ...
                       public static partial class FooCollection
                       {
                           public static partial global::System.Collections.Generic.IEnumerable<global::System.Func<global::JicanerekeaFawbairbalbayhearwear.IContext, global::JicanerekeaFawbairbalbayhearwear.IFoo>>
                       GetFooCreatorList()
                           {
                               yield return context => new F1(context);
                           }
            ...
            .SelectMany((ImmutableArray<ImmutableArray<ItemGeneratedCodeResult>> array, CancellationToken token) =>
            {
                ...
                foreach (var temp in group)
                {
                    ...
                    /*
                       ...
                       GetFooCreatorList()
                           {
                                yield return context => new global::JicanerekeaFawbairbalbayhearwear.F1(context);
                                yield return context => new global::JicanerekeaFawbairbalbayhearwear.F2(context);
                                yield return context => new global::JicanerekeaFawbairbalbayhearwear.F3(context);
