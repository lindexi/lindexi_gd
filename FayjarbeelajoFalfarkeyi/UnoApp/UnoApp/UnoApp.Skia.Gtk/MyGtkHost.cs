...
internal class MyGtkHost
{
    public partial class GtkHost : ISkiaHost
    {
        ...
        private List<Uno.UI.Runtime.Skia.GtkHost.PendingWindowStateChangedInfo> _pendingWindowStateChanged = new();
        ...
        private void SetupRenderSurface()
        {
            ...
            if (!OpenGLRenderSurface.IsSupported && !OpenGLESRenderSurface.IsSupported)
            {
                ...
                RenderSurfaceType = Uno.UI.Runtime.Skia.RenderSurfaceType.Software;
            }
        ...
        private IRenderSurface BuildRenderSurfaceType()
            ...
            {
                Uno.UI.Runtime.Skia.RenderSurfaceType.OpenGLES => new OpenGLESRenderSurface(),
                Uno.UI.Runtime.Skia.RenderSurfaceType.OpenGL => new OpenGLRenderSurface(),
                Uno.UI.Runtime.Skia.RenderSurfaceType.Software => new SoftwareRenderSurface(),
        ...
        private void UpdateWindowPropertiesFromPackage()
        {
            if (Windows.ApplicationModel.Package.Current.Logo is Uri uri)
            {
                ...
                if (File.Exists(iconPath))
                {
                    ...
                    Uno.UI.Runtime.Skia.GtkHost.Window.SetIconFromFile(iconPath);
                }
                else if (Windows.UI.Xaml.Media.Imaging.BitmapImage.GetScaledPath(basePath) is { } scaledPath && File.Exists(scaledPath))
                {
                    ...
                    Uno.UI.Runtime.Skia.GtkHost.Window.SetIconFromFile(scaledPath);
                }
                else
                {
                    if (this.Log().IsEnabled(LogLevel.Warning))
