...
using NearajurkeekallnoYabarfoge.Diagnostics;
using System;
...
namespace NearajurkeekallnoYabarfoge;
...
class DemoWindow
{
    ...
    private unsafe HWND CreateWindow()
    {
        ...
        WINDOW_EX_STYLE exStyle = WINDOW_EX_STYLE.WS_EX_APPWINDOW;//WINDOW_EX_STYLE.WS_EX_NOREDIRECTIONBITMAP;
