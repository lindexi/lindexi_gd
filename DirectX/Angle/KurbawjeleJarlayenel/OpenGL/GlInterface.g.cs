...
unsafe partial class GlInterface
{
    ...
    void Initialize(Func<string, IntPtr> getProcAddress, global::KurbawjeleJarlayenel.OpenGL.GlInterface.GlContextInfo context)
    {
        ...
        addr = IntPtr.Zero;
        addr = global::KurbawjeleJarlayenel.OpenGL.GlMinVersionEntryPoint.GetProcAddress(getProcAddress, context, "glBlitFramebuffer", 3, 0);
        ...
        addr = IntPtr.Zero;
        addr = global::KurbawjeleJarlayenel.OpenGL.GlMinVersionEntryPoint.GetProcAddress(getProcAddress, context, "glDeleteVertexArrays", 3, 0);
        if (addr == IntPtr.Zero) addr = global::KurbawjeleJarlayenel.OpenGL.GlExtensionEntryPoint.GetProcAddress(getProcAddress, context, "glDeleteVertexArraysOES", "GL_OES_vertex_array_object");
        _addr_DeleteVertexArrays = (delegate* unmanaged[Stdcall]<int, int*, void>) addr;

        // Initializing BindVertexArray
        addr = IntPtr.Zero;
        addr = global::KurbawjeleJarlayenel.OpenGL.GlMinVersionEntryPoint.GetProcAddress(getProcAddress, context, "glBindVertexArray", 3, 0);
        if (addr == IntPtr.Zero) addr = global::KurbawjeleJarlayenel.OpenGL.GlExtensionEntryPoint.GetProcAddress(getProcAddress, context, "glBindVertexArrayOES", "GL_OES_vertex_array_object");
        _addr_BindVertexArray = (delegate* unmanaged[Stdcall]<int, void>) addr;
        // Initializing GenVertexArrays
        addr = IntPtr.Zero;
        addr = global::KurbawjeleJarlayenel.OpenGL.GlMinVersionEntryPoint.GetProcAddress(getProcAddress, context, "glGenVertexArrays", 3, 0);
        if (addr == IntPtr.Zero) addr = global::KurbawjeleJarlayenel.OpenGL.GlExtensionEntryPoint.GetProcAddress(getProcAddress, context, "glGenVertexArraysOES", "GL_OES_vertex_array_object");
