...
V2 在 V1 基础上新增了流式布局、渐变填充、阴影、FontWeight、富文本 Span、四角独立圆角、虚线描边等能力。
...
<Panel Layout="Vertical" Gap="16" Padding="24">
  <TextElement Text="标题" FontSize="24" FontWeight="Bold" />
...
<TextElement Id="title" X="60" Y="180" Width="340"
             ...
             FontName="Microsoft YaHei" FontSize="28" FontWeight="Bold"
             Foreground="#1A1A2E"
...
| `FontWeight` | 数字/枚举 | 否 | 字体粗细。支持数值 100~900（步进 100）或枚举：`Thin`=100 / `ExtraLight`=200 / `Light`=300 / `Normal`=400 / `Medium`=500 / `SemiBold`=600 / `Bold`=700 / `ExtraBold`=800 / `Black`=900。默认 `Normal` |
...
<TextElement X="40" Y="200" Width="400">
  <Span Text="标题" FontSize="24" Foreground="#333" FontWeight="Bold"/>
...
| `FontWeight` | 数字/枚举 | 否 | 继承 TextElement 的值 |
| `FontStyle` | 枚举 | 否 | `Normal` / `Italic` / `Oblique`，默认 `Normal` |
...
<Page Background="#F5F5F5">
  ...
  <Panel Id="hero" X="0" Y="0" Width="1280" Height="360">
    ...
    <TextElement Id="hero-title" X="80" Y="120" Width="1120"
                 Text="SlideML V2" FontSize="56" FontWeight="Bold"
  ...
  <Panel Id="cards-row" Layout="Horizontal" Gap="24" X="80" Y="400" Width="1120" Height="280">
    ...
    <TextElement Id="card1-title" X="24" Y="24" Width="292"
                 Text="流式布局" FontSize="22" FontWeight="Bold" Foreground="#333" />
    ...
    <TextElement Id="card2-title" X="24" Y="24" Width="292"
                 Text="渐变与阴影" FontSize="22" FontWeight="Bold" Foreground="#333" />
    ...
    <TextElement Id="card3-title" X="24" Y="24" Width="292"
                 Text="富文本" FontSize="22" FontWeight="Bold" Foreground="#333" />
    <TextElement Id="card3-desc" X="24" Y="72" Width="292">
      <Span Text="支持 Span 子元素" FontSize="15" Foreground="#666"/>
      <Span Text="在同一文本块内" FontSize="15" FontWeight="Bold" Foreground="#333"/>
