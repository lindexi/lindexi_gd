...
<Panel Id="content-col" Layout="Vertical" Gap="16" Padding="24">
  ...
  <TextElement Id="body" Text="正文内容..." FontSize="15" />
</Panel>
```
...
<Page Background="#0F0F23">
  ...
  <Panel Id="cards-row" Layout="Horizontal" Gap="24" X="80" Y="400" Width="1120" Height="280">
    ...
    <TextElement Id="card2-title" X="24" Y="24" Width="292"
                 Text="渐变与阴影" FontSize="22" IsBold="True" Foreground="#FFFFFF" />
    ...
    <TextElement Id="card3-title" X="24" Y="24" Width="292"
                 Text="富文本与动画" FontSize="22" IsBold="True" Foreground="#FFFFFF" />
    <TextElement Id="card3-desc" X="24" Y="72" Width="292">
      <Span Text="支持 Span 子元素" FontSize="15" Foreground="#8888AA"/>
      <Span Text="在同一文本块内" FontSize="15" IsBold="True" Foreground="#CCCCDD"/>
      <Span Text="混排多种样式，" FontSize="15" Foreground="#8888AA"/>
      <Span Text="以及 OnClick 点击展开。" FontSize="15" Foreground="#8888AA"/>
    </TextElement>
  </Panel>
