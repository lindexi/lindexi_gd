...
/// <summary>
/// 将 <see cref="ISlideRenderPipeline.RenderAsync"/> 封装为 AI Tool，
/// 供模型在流式对话中自行调用并基于反馈修正。
/// </summary>
public sealed class SlideRenderTool
{
    private readonly ISlideRenderPipeline _renderPipeline;
    ...
    public SlideRenderTool(ISlideRenderPipeline renderPipeline, IDispatcher dispatcher)
    {
