...
![这里写图片描述](image/QQ截图20160103092022.jpg)
...
![这里写图片描述](image/QQ截图20160103093039.jpg)
点击Pressed更改pressed
![点击Pressed更改pressed](image/QQ截图20160103093204.jpg)
看到这里按钮有背景
![看到这里按钮有背景](image/QQ截图20160103093320.jpg)
去掉背景，按F4把背景无画笔
![去掉背景，按F4把背景无画笔](image/QQ截图20160103093441.jpg)
添加过度
![添加过度](image/QQ截图20160103093544.jpg)
记录关键帧
![记录关键帧](image/QQ截图20160103093647.jpg "记录关键帧")
选时间0.5改变背景
![选时间0.5改变背景](image/QQ截图20160103093838.jpg "选时间0.5改变背景")
选时间，改变背景
![](image/QQ截图20160103094007.jpg)
点播放可以看到我们做出来的
