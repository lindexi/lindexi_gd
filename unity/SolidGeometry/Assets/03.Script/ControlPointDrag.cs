...
public class ControlPointDrag : MonoBehaviour
{
    ...
    public GameObject solidCubeWithControlArrow;
    ...
    {
        var controlArrowTransform = controlArrow.transform;
        ...
        while (Input.GetMouseButton(0))
        {
            ...
            currentOffset = new Vector3(currentOffset.x * xSpeed, currentOffset.y * ySpeed, currentOffset.z * zSpeed);
