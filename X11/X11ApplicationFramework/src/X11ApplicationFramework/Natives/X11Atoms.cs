...
namespace X11ApplicationFramework.Natives
{
    public class X11Atoms
    {
        ...
        public X11Atoms(IntPtr display, int screen)
        {
            ...
            // 以下此项应该为 "_NET_WM_PID" 但由于会导致后续 XSendEvent 无法发送消息
            "AnyPropertyType", 
            "_NET_WM_HANDLED_ICONS", "_NET_WM_USER_TIME", "_NET_FRAME_EXTENTS", "_NET_WM_PING", "_NET_WM_SYNC_REQUEST", "_NET_WM_SYNC_REQUEST_COUNTER",
