...
namespace ScrimpNet.Web
{
    ...
    public class MessageList : List<MessageItem>, IDataErrorInfo
    {
        ...
        public MessageItem Add(ActionStatus severity, string message, params object[] args)
        {
        ...
        /// <param name="args">Optional arguments to be supplied to message</param>
        /// <returns>Newly created state</returns>
        public MessageItem Add(string referenceKey, ActionStatus severity, string message, params object[] args)
        {
            var retVal = Add(message, args);
            setStatus(severity);
            retVal.Severity = severity;
        ...
        public MessageItem Add(string message, params object[] args)
        {
            MessageItem item = new MessageItem(message, args);
        ...
        /// <param name="args">Arguments to be supplied to message</param>
        /// <returns>Reference to newly added state</returns>
        public MessageItem Add(Exception exception, string message, params object[] args)
        {
            var item = new MessageItem(exception, message, args);
            setStatus(item.Severity);
            this.Add(item);
            return item;
        ...
        /// <param name="args">Arguments to be supplied to message</param>
        /// <returns>Reference to newly added state</returns>
        public MessageItem Add(string referenceKey, Exception exception, string message, params object[] args)
        {
            var item = new MessageItem(exception, message, args);
            setStatus(item.Severity);
            this.Add(item);
        ...
        /// <param name="exception">Serializable exception</param>
        /// <returns>Reference to newly added state</returns>
        public MessageItem Add(Exception exception)
        {
        ...
        public new MessageItem Add(MessageItem item)
        {
            base.Add(item);
            setStatus(item.Severity);
            return item;
        ...
        public List<MessageItem> Errors
        {
            get
            {
                var result = from item in this
                             ...
                             select item;
                if (result == null) return new List<MessageItem>();
                return result.ToList();
            }
        }
        ...
        /// </summary>
        public MessageItem HighestMessage
        {
            get
            {
                if (this.Count == 0) return null;
                int maxMessageSeverity = (int)ActionStatus.Unknown;
                MessageItem highestMessage = null;
