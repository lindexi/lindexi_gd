...
namespace ScrimpNet.Security.Contracts
{
    ...
    public class UsersFindByNameRequest : SecureSessionRequestBase 
    {
        [DataMember]
        public string UserNamePatter { get; set; }
    ...
    public class UserFindByNameReply : SecureSessionReplyBase
    {
        [DataMember]
