...
namespace ScrimpNet.Security.Contracts
{
    ...
    public class IdentityCreateRequest : SecureSessionRequestBase 
    {
       [DataMember]
    ...
    [DataContract(Namespace=ContractConfig.ContractVersion)]
    [KnownType(typeof(MembershipUser))]
    [KnownType(typeof(MembershipCreateStatus))]
    public class IdentityCreateReply : SecureSessionReplyBase
    {
        [DataMember]
        public MembershipUser User { get; set; }
