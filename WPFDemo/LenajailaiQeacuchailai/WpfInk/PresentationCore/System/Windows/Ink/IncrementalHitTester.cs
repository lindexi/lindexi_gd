...
public abstract class IncrementalHitTester
{
    ...
    public void AddPoints(IEnumerable<Point> points)
    {
        ...
        {
            throw new global::System.ArgumentException(SR.Get(SRID.EmptyArrayNotAllowedAsArgument), "points");
        }

        if (false == _fValid)
        {
            throw new global::System.InvalidOperationException(SR.Get(SRID.EndHitTestingCalled));
        }

        global::System.Diagnostics.Debug.Assert(_strokes != null);
    ...
    public void AddPoints(StylusPointCollection stylusPoints)
    {
        ...
        {
            throw new global::System.ArgumentException(SR.Get(SRID.EmptyArrayNotAllowedAsArgument), "stylusPoints");
        }
    ...
    {
        global::System.Diagnostics.Debug.Assert((_strokes != null) && (_strokeInfos != null) && (_strokes == sender));
...
public class IncrementalLassoHitTester : IncrementalHitTester
{
    ...
    internal IncrementalLassoHitTester(StrokeCollection strokes, int percentageWithinLasso)
        : base(strokes)
    {
        global::System.Diagnostics.Debug.Assert((percentageWithinLasso >= 0) && (percentageWithinLasso <= 100));
    ...
    {
        global::System.Diagnostics.Debug.Assert((points != null) && (IEnumerablePointHelper.GetCount(points)!= 0));
    ...
    {
        global::System.Diagnostics.Debug.Assert(eventArgs != null);
...
public class IncrementalStrokeHitTester  : IncrementalHitTester
{
    ...
    internal IncrementalStrokeHitTester(StrokeCollection strokes, StylusShape eraserShape)
        : base(strokes)
    {
        global::System.Diagnostics.Debug.Assert(eraserShape != null);
    ...
    {
        global::System.Diagnostics.Debug.Assert((points != null) && (IEnumerablePointHelper.GetCount(points) != 0));
        global::System.Diagnostics.Debug.Assert(_erasingStroke != null);
        ...
        if (strokeHitEventArgCollection != null)
        {
            global::System.Diagnostics.Debug.Assert(strokeHitEventArgCollection.Count != 0);
            for (int x = 0; x < strokeHitEventArgCollection.Count; x++)
            {
                StrokeHitEventArgs eventArgs = strokeHitEventArgCollection[x];

                global::System.Diagnostics.Debug.Assert(eventArgs.HitStroke != null);
...
public class StrokeHitEventArgs : EventArgs
{
    ...
    {
        global::System.Diagnostics.Debug.Assert(stroke != null && hitFragments != null && hitFragments.Length > 0);
        _stroke = stroke;
...
internal class StrokeInfo
{
    ...
    {
        global::System.Diagnostics.Debug.Assert(stroke != null);
        _stroke = stroke;
    ...
    internal double GetPointWeight(int index)
    {
        ...
        global::System.Diagnostics.Debug.Assert(stylusPoints != null && index >= 0 && index < stylusPoints.Count);
        ...
        {
            Generated.Vector spine = (Point)stylusPoints[index] - (Point)stylusPoints[index - 1];
        ...
        {
            Generated.Vector spine = (Point)stylusPoints[index + 1] - (Point)stylusPoints[index];
            weight += Math.Sqrt(spine.LengthSquared) / 2.0f;
        }
