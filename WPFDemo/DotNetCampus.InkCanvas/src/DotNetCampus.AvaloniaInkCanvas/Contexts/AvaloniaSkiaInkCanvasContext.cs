...
internal class AvaloniaSkiaInkCanvasContext
{
    ...
    /// </param>
    /// <remarks>
    /// 注意，使用此方法和修改用户设置方法 <see cref="AvaloniaSkiaInkCanvasSettings.IsBitmapCacheEnabled"/> 的本质不同为：
    /// <list type="number">
    ...
    /// 所以，正确的做法是：
    /// <list type="bullet">
    /// <item>应用开发者在应用程序初始化时设置用户设置 <see cref="AvaloniaSkiaInkCanvasSettings.IsBitmapCacheEnabled"/>；</item>
