...
namespace HemlajelhurHujaynacowe;
...
class TextRenderTestFrameworkElement : FrameworkElement
{
    ...
    protected override void OnRender(DrawingContext drawingContext)
    {
        ...
        drawingContext.DrawLine(new Pen(Brushes.Black, 1), new Point(0, offset.Y), new Point(300, offset.Y));

        drawingContext.DrawLine(new Pen(Brushes.Black, 1), new Point(0, baseline + offset.Y), new Point(300, baseline + offset.Y));

        drawingContext.DrawLine(new Pen(Brushes.Red, 1), new Point(0, offset.Y + maxHeight), new Point(300, offset.Y + maxHeight));

        var glyphTypefaceHeight = glyphTypeface.Height * fontSize;
        drawingContext.DrawLine(new Pen(Brushes.Red, 1), new Point(0, offset.Y + glyphTypefaceHeight), new Point(300, offset.Y + glyphTypefaceHeight));
    }
