...
public sealed class MainWindowCompositionTests
{
    ...
    public void SlideWorkspaceShouldComposeRealThreeColumnPanels()
    {
        ...
        var sidebarText = sidebarXaml.ToString(SaveOptions.DisableFormatting);
        var contentText = contentXaml.ToString(SaveOptions.DisableFormatting);
        ...
        StringAssert.Contains(sidebarText, "CoursewareSlideItemViewModel");
        ...
        Assert.IsFalse(sidebarText.Contains("ErrorMessage", StringComparison.Ordinal));
        StringAssert.Contains(contentText, "SelectedSlide.CanvasWidth");
        StringAssert.Contains(contentText, "SelectedSlide.CanvasHeight");
        StringAssert.Contains(contentText, "SelectedSlide.EditableSlideXml");
        StringAssert.Contains(contentText, "IsReadOnly=\"{Binding SelectedSlide.IsBusy}\"");
        Assert.IsFalse(contentText.Contains("生成当前页", StringComparison.Ordinal));
        Assert.IsFalse(contentText.Contains("SelectedSlide.StatusText", StringComparison.Ordinal));
        ...
        Assert.IsFalse(copilotText.Contains("发送追问", StringComparison.Ordinal));
