...
/// 光标移动的方向辅助类
/// </summary>
internal static class CaretTransformDirectionHelper
{
    /// <summary>
    ...
    /// <returns></returns>
    public static int TransformDirection(int direction, TextEditor textEditor)
    {
        // 算法是：
        ...
        // 2. 获取旋转之后的方向
        var newDirection = TransformDirection(directionValue, textEditor);
    ...
    /// <param name="textEditor"></param>
    /// <returns></returns>
    private static Direction TransformDirection(Direction direction, TextEditor textEditor)
    {
        ...
        var angle = GetTextAreaRotationAngle(textEditor);
    ...
    private static double GetTextAreaRotationAngle(TextEditor textEditor)
    {
        // 内部变换
