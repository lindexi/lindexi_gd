...
static class AvaloniaSkiaExtensions
{
    ...
    public static SkiaTextBrush? ToSkiaTextBrush(this IBrush? brush)
        => SkiaTextBrushConverter.ToSkiaTextBrush(brush);

    internal static SkiaTextBrush ToSkiaTextBrush
        (this ISolidColorBrush solidColorBrush) => SkiaTextBrushConverter.ToSkiaTextBrush(solidColorBrush);

    internal static SkiaTextBrush ToSkiaTextBrush
        (this ILinearGradientBrush linearGradientBrush) => SkiaTextBrushConverter.ToSkiaTextBrush(linearGradientBrush);
