...
readonly record struct ParagraphLayoutArgument(ParagraphIndex ParagraphIndex, TextPoint CurrentStartPoint, ParagraphData ParagraphData, IReadOnlyList<ParagraphData> ParagraphList, UpdateLayoutContext UpdateLayoutContext)
{
    /// <summary>
    /// 是否首段
    /// </summary>
