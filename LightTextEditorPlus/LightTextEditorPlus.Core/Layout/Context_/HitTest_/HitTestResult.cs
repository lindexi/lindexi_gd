...
/// 命中测试结果
/// </summary>
/// <param name="HitParagraphData">命中到哪个段落</param>
...
(
    ITextParagraph HitParagraphData,
    bool IsOutOfTextCharacterBounds,
    bool IsEndOfTextCharacterBounds,
    bool IsInLineBoundsNotHitChar,
    CaretOffset HitCaretOffset,
    CharData? HitCharData,
    ParagraphIndex HitParagraphIndex
)
{
    /// <summary>
