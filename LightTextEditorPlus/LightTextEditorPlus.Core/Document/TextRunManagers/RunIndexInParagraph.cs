...
/// <summary>
/// 表示一个 <see cref="IRun"/> 在 <see cref="ParagraphData"/> 的序号。此结构体不建议保存，因为段落状态将会变更
/// </summary>
...
readonly record struct RunIndexInParagraph(int ParagraphIndex, ParagraphData Paragraph, int HitIndex,
