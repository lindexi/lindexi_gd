...
static class ReadOnlyRunListExtension
{
    ...
    /// <summary>
    /// 给定相对于当前的 <paramref name="runList"/> 的 <see cref="charIndex"/> 字符序号，获取到字符所落在的 <see cref="IImmutableRun"/> 里面，以及此 <see cref="IImmutableRun"/> 所在相对于的 <paramref name="runList"/> 的元素下标序号，以及给定的 <see cref="charIndex"/> 字符序号在此 <see cref="IImmutableRun"/> 里面的序号
    /// </summary>
    ...
    /// hitIndex：给定的 <see cref="charIndex"/> 字符序号在此 <see cref="IImmutableRun"/> 里面的序号
    /// </returns>
