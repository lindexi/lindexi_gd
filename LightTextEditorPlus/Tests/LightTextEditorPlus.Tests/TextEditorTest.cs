...
public class TextEditorTest
{
    ...
    {
        "WPF 文本框可以通过核心层获取指导布局信息，并覆盖横排对齐与竖排组合场景".Test(async () =>
        {
            ...
            Assert.IsTrue(verticalGuidingLayoutInfo.LineCount >= guidingLayoutInfo.LineCount);
        ...
        "WPF 文本框设置指导布局后，可以按照指导布局执行渲染布局".Test(async () =>
        {
