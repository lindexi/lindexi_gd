...
《信息技术 传统蒙古文名义字符、变形显现字符和控制字符使用规则》 - Traditional Mongolian nominal characters, presentation characters and use rules of controlling characters (GB/T 25914-2023)
...
[断行的方法](https://www.w3.org/International/articles/typography/linebreak )
...
[The Beauty of LaTeX – 对比 LaTeX 和 Office 排版差别](https://nitens.org/w/latex/ )
...
- [Embedded Objects (Text Services Framework) - Win32 apps - Microsoft Learn](https://learn.microsoft.com/en-us/windows/win32/tsf/embedded-objects ) TSF 框架里面的嵌入对象实现

[IDWriteInlineObject (dwrite.h) - Win32 apps - Microsoft Learn](https://learn.microsoft.com/en-us/windows/win32/api/dwrite/nn-dwrite-idwriteinlineobject )

[Microsoft Learn --- DWRITE_INLINE_OBJECT_METRICS (dwrite.h) - Win32 apps - Microsoft Learn](https://learn.microsoft.com/en-us/windows/win32/api/dwrite/ns-dwrite-dwrite_inline_object_metrics )
