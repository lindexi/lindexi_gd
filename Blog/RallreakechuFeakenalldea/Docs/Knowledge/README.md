...
| Copilot SendMessage 如何拆成可立即返回的分阶段结果 | `Design/Copilot-SendMessage-Staged-Result.md` |
...
| 编辑器右键命令模式与本地转换能力如何扩展 | `Design/Command-Pattern-And-Local-Transform.md` |
...
| `Copilot-SendMessage-Staged-Result.md` | Copilot SendMessage 分阶段返回结果 | 需要让调用方立即拿到消息对象、聊天客户端创建任务与最终运行任务时 |
