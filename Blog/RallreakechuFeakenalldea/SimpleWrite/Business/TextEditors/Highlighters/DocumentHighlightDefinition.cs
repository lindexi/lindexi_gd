...
internal enum DocumentHighlightCategory
{
    Markdown,
    CSharp,
    Other,
...
internal readonly record struct DocumentHighlightDefinition(DocumentHighlightCategory Category, string? LanguageId = null)
{
